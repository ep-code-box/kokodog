 ...
 * @version 1.0
 */
@Repository("getScnrioLstDao")
public class GetScnrioLstDaoImpl implements GetScnrioLstDao {
  private static Logger logger = LogManager.getLogger(GetScnrioLstDaoImpl.class);
  ...
  public List<Map<String, Object>> getScnrioLst(Map<String, Object> inputMap) throws SQLException {
    logger.debug("============   Start method of GetScnrioLstDaoImpl.getScnrioLst   ============");
    logger.debug("Parameter inputMap[" + inputMap.toString() + "]");
    List<Map<String, Object>> outputList = null;
    outputList = sqlSession.selectList("com.skd.sel.sel_scnrio_mng.getScnrioLst", inputMap);
    logger.debug("Output List[" + outputList.toString() + "]");
    logger.debug("============   End method of GetScnrioLstDaoImpl.getScnrioLst   ============");
    return outputList;
  }
}