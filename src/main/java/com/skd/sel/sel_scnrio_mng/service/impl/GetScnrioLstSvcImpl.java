 ...
 * @version 1.0
 */
@Service("getScnrioLstSvc")
public class GetScnrioLstSvcImpl implements GetScnrioLstSvc {
  private static Logger logger = LogManager.getLogger(GetScnrioLstSvcImpl.class);
  ...
  public List<Map<String, Object>> getScnrioLst(Map<String, Object> inputMap) throws Exception {
    return getScnrioLstDao.getScnrioLst(inputMap);
  }
}